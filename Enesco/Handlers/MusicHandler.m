...
+ (void)configNowPlayingInfoCenter {
    if (NSClassFromString(@"MPNowPlayingInfoCenter")) {
        ...
        NSLog(@"%@ audioDurationSeconds %@",[NSString timeIntervalToMMSSFormat:[[MusicViewController sharedInstance].streamer currentTime]],[NSString timeIntervalToMMSSFormat:[[MusicViewController sharedInstance].streamer duration]]);
